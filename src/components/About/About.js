...
const About = () => {
    return (
        <div className="about">
            <h1 className="text-center p-3 bg-white">About us</h1>
            <h2 className='text-center p-3 '>The benefits of quizzing your workforce</h2>
